 ...
 */
function d8sess_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['d8sess_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('d8sess sample setting'),
  '#default_value' => theme_get_setting('d8sess_example'),
